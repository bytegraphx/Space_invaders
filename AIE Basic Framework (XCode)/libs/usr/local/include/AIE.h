...
// Enumerator to Describe Sprite Blend Modes
...
// Enumerator to Describe camera Movement Directions
...
// DLLEXPORT void			AddFont(const char* a_pFontName); // was missing grabed fron other framework but doesn't work
// DLLEXPORT void			SetFont(const char* a_pFontName); //was missing grabed fron other framework but doesn't work
// DLLEXPORT void			RemoveFont(const char* a_pFontName); //was missing grabed fron other framework but doesn't work
